#
# Raspberry Pi Pico2 W RP2350 (DebugProbe CMSIS-DAP).mk
...
#
# Created: 02 Jan 2025 release 14.6.8
# 
...
BOARD_TAG = rpipico2w
# Program / File system
BOARD_TAG1 = rpipico2w.menu.flash.4194304_0
# Speed nominal = 133
BOARD_TAG2 = rpipico2w.menu.freq.150
# Debug port, requires TinyUSB
BOARD_TAG3 = rpipico2w.menu.dbgport.Disabled
# BOARD_TAG3 = rpipico2w.menu.dbgport.Serial
# Debug level
BOARD_TAG4 = rpipico2w.menu.dbglvl.None
# USB stack, TinyUSB for Serial
# BOARD_TAG5 = rpipico2w.menu.usbstack.tinyusb
BOARD_TAG5 = rpipico2w.menu.usbstack.picosdk
# Stack protect, default = disabled
BOARD_TAG6 = rpipico2w.menu.stackprotect.Disabled
# Exception, default = disabled
BOARD_TAG7 = rpipico2w.menu.exceptions.Disabled
# Upload method
BOARD_TAG8 = rpipico2w.menu.uploadmethod.picoprobe_cmsis_dap
# Country for WiFi
...
BOARD_TAG10 = rpipico2w.menu.ipbtstack.ipv4btcble

# For RP2350, selection of ARM or RiscV
BOARD_TAG11 = rpipico2w.menu.arch.arm
...
CONFIG_NAME = Raspberry Pi Pico2 W RP2350 (DebugProbe CMSIS-DAP)
