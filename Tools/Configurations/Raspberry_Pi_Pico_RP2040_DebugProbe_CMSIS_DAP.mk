#
# Raspberry Pi Pico RP2040 (DebugProbe CMSIS-DAP).mk
...
# Upload method
BOARD_TAG8 = rpipico.menu.uploadmethod.picoprobe_cmsis_dap
# Country for WiFi
...
CONFIG_NAME = Raspberry Pi Pico RP2040 (DebugProbe CMSIS-DAP)
