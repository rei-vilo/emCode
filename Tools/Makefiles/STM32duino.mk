...
CMSIS_DSP_PATH = $(STM32DUINO_INITIAL)/tools/CMSIS_DSP/$(STM32DUINO_CMSIS_DSP_RELEASE)
CMSIS_NN_PATH = $(STM32DUINO_INITIAL)/tools/CMSIS_NN/$(STM32DUINO_CMSIS_NN_RELEASE)
...
# unused CORE_H_SRCS = $(foreach dir,$(CORE_LIB_PATH),$(wildcard $(dir)/*.h))
...
WORK_0a = $(call PARSE_FILE,build,usb_flags=,$(HARDWARE_PATH)/platform.txt)
...
WORK_0d = $(shell echo '$(WORK_0c)' | sed 's:{build.pid}:$(BUILD_PID):g')

BUILD_USB_FLAGS = $(WORK_0d)
...
WORK_1b = $(shell echo '$(WORK_1a)' | sed 's:{build.bootloader_flags}:$(BUILD_BOOTLOADER_FLAGS):g')
WORK_1c = $(shell echo '$(WORK_1b)' | sed 's:{build.enable_virtio}:$(BUILD_ENABLE_VIRTIO):g')
WORK_1d = $(shell echo '$(WORK_1c)' | sed 's:{build.product_line}:$(BUILD_PRODUCT_LINE):g')
WORK_1e = $(shell echo '$(WORK_1d)' | sed 's:{build.xSerial}:$(BUILD_XSERIAL):g')
WORK_1f = $(shell echo '$(WORK_1e)' | sed 's:{build.enable_usb}:$(BUILD_ENABLE_USB):g')
