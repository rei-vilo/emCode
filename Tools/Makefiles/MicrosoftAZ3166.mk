...
#     UPLOADER = 0
#     # unused DEBUG_SERVER_PATH = $(APPLICATION_PATH)/tools/openocd/$(MICROSOFT_OPENOCD_RELEASE)/macosx
#     # unused DEBUG_SERVER_NAME = openocd
#     # unused DEBUG_SERVER_EXEC = $(DEBUG_SERVER_PATH)/bin/$(DEBUG_SERVER_NAME)
#     # unused DEBUG_SERVER_OPTS = -f $(DEBUG_SERVER_PATH)/scripts/interface/stlink-v2-1.cfg
#     # unused DEBUG_SERVER_OPTS += -c \"transport select hla_swd\"
#     # unused DEBUG_SERVER_OPTS += -f $(DEBUG_SERVER_PATH)/scripts/target/stm32f4x.cfg
...
WORK_0 += $(foreach dir1,$(APP_LIB_PATH),$(foreach dir2,$(APP_LIBS_LIST),$(shell find $(dir1)/$(dir2)/src -type d))))

# WORK_0 += $(foreach dir,$(APP_LIB_PATH),$(patsubst %,$(shell find $(dir)/%/src/$(BUILD_CORE) -type d),$(APP_LIBS_LIST)))
...
APP_LIB_IPP_SRC = $(foreach dir,$(WORK_0),$(wildcard $(dir)/*.ipp))
