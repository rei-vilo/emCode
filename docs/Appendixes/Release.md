# emCode {{ version }} release notes

​emCode is the continuation of embedXcode.

emCode relies on Visual Studio Code and runs on Linux, including Windows Linux Sub-system (WSL).
