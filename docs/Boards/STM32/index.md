...
![](img/Logo-064-STM32duino.png) The STM32 platform includes the Nucleo and Discovery boards based on the STM32 MCUs.

[STM32duino](./STM32.md) :octicons-link-16: supports a wide range of STM32-based boards.
...
---- | ---- | ---- | ---- | ----
![](img/Logo-064-STM32duino.png) | **STM32** | 2.6.0 | | For Nucleo and Discovery boards
![](img/Logo-064-eC.png) | **emCode** | 14.1.5 | 19 Jul 2023 |
