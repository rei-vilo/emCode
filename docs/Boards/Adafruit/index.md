# Manage the Adafruit platform

![](img/Logo-064-Adafruit.png) The Adafruit platform includes boards based on ESP8266, ESP32, nRF52, SAMD, RP2040 and AVR.

The installation is performed with Arduino-CLI.

+ [Feather ESP8266](./ESP8266.md)
+ [Feather ESP32](./ESP32.md)
+ [Feather nRF52832 and nRF52840](./nRF52.md)
+ [Feather M0 and M4](./Cortex-M.md)
+ [Feather RP2040](./RP2040.md)
+ [Trinket and Trinket Pro AVR](./AVR.md)
...
Forum | <http://forums.adafruit.com> :octicons-link-external-16:
