...
![](img/Logo-064-Arduino.png) The Arduino platform includes boards based on the AVR, MegaAVR, SAM, SAMD, nRF52, RP2040.

The installation is performed with Arduino-CLI.

+ [Arduino AVR](./AVR.md);
+ [Arduino MegaAVR](./MegaAVR.md);
+ [Arduino SAM](./SAM.md);
+ [Arduino SAMD](./SAMD);
+ [Arduino ESP32](./ESP32.md);
+ [Arduino nRF52](./nRF52.md);
...
![](img/Logo-064-eC.png) | **emCode** | 14.3.3 |
