...
The Seeed SAMD platform includes two main lines of boards: the compact Xiao and the Wio Terminal.
...
![](img/Logo-064-Seeeduino.png) The Seeeduino SAMD boards offer multiple options for uploading, two for the Wio Terminal and three for the Xiao M0 board.
...
+ Please refer to [How to Use Wio Terminal as RTL8720DN Dev Board](https://wiki.seeedstudio.com/Wio-Terminal-8720-dev) :octicons-link-external-16: on the Seeed Studio website.
...
<center>![](img/410-02-420.png)</center>
