...
The [Raspberry Pi Pico RP2040 platform](https://arduino-pico.readthedocs.io/en/latest/) :octicons-link-external-16: provides an excellent solution for all the boards based on the Raspberry Pi RP2040 MCU.
