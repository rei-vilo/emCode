...
The [Raspberry Pi Pico RP2040 platform by Earle F. Philhower, III](https://arduino-pico.readthedocs.io/en/latest/) :octicons-link-external-16: provides an excellent solution for all the boards based on the Raspberry Pi RP2040 MCU.
...
+ Please refer to [Power the board with the Segger J-Link debug probe](../../Develop/Run.md/#power-the-board-with-the-segger-j-link-debug-probe).
